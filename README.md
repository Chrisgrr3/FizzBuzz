This simple Java program determines whether an inputted number is divisible by 3, 5, or neither. If the number is divisible by 3 and not 5, then the output will be "Fizz".
